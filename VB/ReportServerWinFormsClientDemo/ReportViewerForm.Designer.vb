...
Namespace ReportServerWinFormsClientDemo
	Partial Public Class ReportViewerForm
		...
		Private Sub InitializeComponent()
			...
			' 
			Me.remoteDocumentSource1.AuthenticationType = DevExpress.ReportServer.Printing.AuthenticationType.Windows
			Me.remoteDocumentSource1.ServiceUri = "http://localhost:83"
			' 
